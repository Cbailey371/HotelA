...
const Layout = () => {
    ...
    return (
        <div className="flex h-[100dvh] bg-slate-50 dark:bg-[#020617] font-sans antialiased text-slate-900 dark:text-slate-100 selection:bg-blue-500 selection:text-white transition-colors duration-300">
